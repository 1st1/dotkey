...
- [[architecture]] — the parse pipeline, four packages, and how the model reaches the DOM
...
- [[usage]] — package selection, integration examples, development, and documentation scope
